...
const Banner = ({
  ...
  return (
    <div className="md:w-full bg-orange-500 h-auto flex flex-col sm:flex-row justify-center sm:justify-between items-center py-10 px-6 sm:px-10 lg:px-20 md:flex md:justify-evenly mt-10 ">
      <div className="flex flex-col items-center sm:items-start ">
        <h1 className="mt-4 sm:mt-20 mb-5 text-4xl sm:text-6xl lg:text-7xl text-white font-bold text-center sm:text-left">
          {bannerHead}
        </h1>
